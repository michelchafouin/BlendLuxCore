...
class LUXCORE_OT_world_set_volume_node_tree(LUXCORE_OT_set_node_tree, bpy.types.Operator):
...
class LUXCORE_VOLUME_MT_world_select_volume_node_tree(LUXCORE_MT_node_tree, bpy.types.Menu):
