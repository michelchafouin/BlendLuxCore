...
class LUXCORE_OT_pointer_set_node_tree(LUXCORE_OT_set_node_tree, bpy.types.Operator):
...
class LUXCORE_MT_pointer_select_node_tree(LUXCORE_MT_node_tree, bpy.types.Menu):
