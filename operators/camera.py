...
class LUXCORE_OT_camera_set_volume_node_tree(LUXCORE_OT_set_node_tree, bpy.types.Operator):
...
class LUXCORE_VOLUME_MT_camera_select_volume_node_tree(LUXCORE_MT_node_tree, bpy.types.Menu):
